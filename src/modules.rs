        ...
        "children": [
            ...
            module(
                ...
                vec![
                    ...
                    submodule("adjustment.carryforward-loss", "5.6", "이월결손금", "/modules/adjustment/carryforward-loss"),
                    submodule("adjustment.tax-credits", "5.7", "세액공제/감면", "/modules/adjustment/tax-credits"),
                    submodule("adjustment.penalty-tax", "5.8", "가산세", "/modules/adjustment/penalty-tax"),
                ],
            ),
            module(
                "forms",
